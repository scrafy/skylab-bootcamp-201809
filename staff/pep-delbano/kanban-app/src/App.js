...
class App extends Component {
    ...
    handleLogin = (username, password) => {
        try {
            logic.login(username, password)  //POST form inputs to API, and 
    ...
    render() {
        ...
        return <div>
            ...
            <Route path="/postits" render={() => logic.loggedIn ? <div className="container-home">
                <nav class="navbar navbar-light bg-dark"><h1 className="nav-title">My Postits</h1> <div className="nav-rightSide" onClick={this.handleLogoutClick}> <i class="fas fa-sign-out-alt"></i> <p>Logout</p> </div> </nav>
                <Postits />
            </div> : <Redirect to="/" />} />
