...
const logic = {
    ...
    savePostit(id, postitId, text) {
        if (typeof id !== 'number') throw TypeError(`${id} is not a number(id)`)
        if (typeof postitId !== 'number') throw TypeError(`${postitId} is not a number(postitId)`)
        if (typeof text !== 'string') throw TypeError(`${text} is not a string`)
